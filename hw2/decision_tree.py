...
class DTClassifier:
  ...
  def calculate_purity_gain(self, y, y1, y2):
    ...
    # use the formula (IG) from slide 25 from Lecture4
    # the fromula for gini index is similar, but using Gini_parent instead of E_parent
    # the inputs are 
  ...
  def divide_on_feature(self, X, y, feature_id, threshold):
    ...
    #                                false cases will be feature < threshold
